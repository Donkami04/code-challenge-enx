...
def upgrade(id, new_plan):
    ...
    try:
        ...
        current_plan = customer["data"]["SUBSCRIPTION"]
        ...
        if result == True:
            ...
            print('You can not downgrade a custommer subscription with this function')
...
def downgrade(id, new_plan):
    ...
    try:
        ...
        if result == False:
            ...
            if new_plan == 'free':
              for feature in customer['data']['ENABLED_FEATURES']:
                customer["data"]["ENABLED_FEATURES"][feature] = False
            ...
            print('You can not upgrade a custommer subscription with this function')
...
def up_or_down(current_plan, new_plan): 
    ...
    if new_plan_value == current_plan_value:
        return (f'The user already has the Subscription {current_plan}')
